...
In the 1970s and 1980s, linguists and structuralist critics often sought to give literary categorization a firm ontological grounding in a deep taxonomy of text types (e.g., narrative / description) ~\cite{genette:genre, biber:typology}. But the prevailing emphasis in contemporary genre theory is nominalistic. Even scholars approaching genre from a formal or philosophical perspective (like Jacques Derrida) eventually found the concept riven with inconsistency~\cite{derrida:genre}. More recently scholars have abbreviated the definitional debate to treat genre simply as a social phenomenon. In the discipline of rhetoric, the emphasis falls on recurring patterns of rhetorical practice; in sociology, it tends to fall more on reception, and on the social differentiations mediated by categorization of art~\cite{devitt:genre, dimaggio:classification}.
