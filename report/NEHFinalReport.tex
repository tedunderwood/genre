...
\caption{Precision-recall graph for fiction datasets limited to various thresholds of confidence.}
\label{ficprecall}
\end{figure}
...
\item \textit{Active learning. Co-training.}
